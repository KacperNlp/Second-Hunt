...
import type { SecondHand, City, OpeningHours } from '~/types/City'
...
function getTodayOpeningHours(openingHours: OpeningHours) {
  const currentDay = openingHours[todayKey];
